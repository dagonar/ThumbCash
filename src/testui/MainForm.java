...
public class MainForm extends JFrame {
    ...
    public MainForm() {
        ...
        enrollmentConfigPanel.setBorder(BorderFactory.createTitledBorder("Enrolamiento"));
        ...
        maxcountPanel.add(new JLabel("Conteo maximo de huellas enroladas"));
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (cb.isSelected()) {
                        JOptionPane.showMessageDialog(MainForm.this,
                                "Para enrolar el dedo, haga clic en Enrolar Huellas.", "Enrolar Huellas",
                                JOptionPane.INFORMATION_MESSAGE);
                        cb.setSelected(false);
//                      templates.put(index, fakeTemplate);
                    } else {
                        if (JOptionPane.showConfirmDialog(MainForm.this,
                                "¿Esta seguro que quiere eliminar la " + Utilities.fingerprintName(index) + "?", "Enrolamiento de Huellas",
