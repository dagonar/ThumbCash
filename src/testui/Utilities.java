...
class Utilities {
    ...
    static {
    	...
    	fingerNames.put(DPFPFingerIndex.LEFT_MIDDLE,  "corazón izquierdo");
    	...
    	fingerNames.put(DPFPFingerIndex.RIGHT_MIDDLE, "corazón derecho");
    ...
    public static String fingerprintName(DPFPFingerIndex finger) {
    	return "huella del dedo " + fingerNames.get(finger); 
    }
